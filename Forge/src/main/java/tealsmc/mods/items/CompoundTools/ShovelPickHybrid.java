...
import components.*;
public class ShovelPickHybrid extends ItemPickaxe {
	...
	public ShovelPickHybrid(PickaxeHead h, ShovelHead A, ItemShaft s) {
		super(EnumHelper.addToolMaterial("modularMat"+h.toString()+A.toString()+s.toString(),
				...
				this.A=A;
				this.s=s;
				name=h.toString()+" "+A.toString()+" "+s.toString()+"Shovel Pick";
		// TODO Auto-generated constructor stub
	}
	public ShovelPickHybrid(PickaxeHead h, ShovelHead A, ItemShaft s,ToolMaterial m) {
		super(m);
				this.h=h;
				this.A=A;
				this.s=s;
